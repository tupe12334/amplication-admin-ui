...
export class JobResolverBase {
  ...
  async createJob(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        clusterGroup: args.data.clusterGroup
          ? {
              connect: args.data.clusterGroup,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => ClusterGroup, { nullable: true })
  @nestAccessControl.UseRoles({
    resource: "Job",
    action: "read",
    possession: "any",
  ...
  async clusterGroup(
    ...
    const result = await this.service.getClusterGroup(parent.id);
